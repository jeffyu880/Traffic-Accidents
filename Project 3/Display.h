...
void displayNewBoard(sf::RenderWindow& window,  std::map<string, sf::ConvexShape>& states,unordered_map<string, RedBlackTree> treeStateMap, unordered_map<string, MaxHeap<Accident>> maxStateMap,vector<StateButton>& stateButtons, string stateSelected) {
